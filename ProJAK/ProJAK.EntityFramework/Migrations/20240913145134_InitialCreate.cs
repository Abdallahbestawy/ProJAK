    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Hards", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GraphicsCardId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    HardId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    HardSize = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_products_Hards_HardId",
                        column: x => x.HardId,
                        principalTable: "Hards",
                        principalColumn: "Id");
                    table.ForeignKey(
